...
** File description:
** Criterion unit tests for the libmy and libcuddle libraries
*/
/**
 * @file unit_tests_lib.c
 * @brief Criterion unit tests for the libmy and libcuddle libraries
...
#include "../lib/Headers/linked_lists.h"
...
//region my_str_isfloat's tests
Test(my_str_isfloat, basic_float, .init = redirect_all_std) { int a = my_str_isfloat("123.456"); cr_assert_eq(a, SUCCESS, "my_str_isfloat should return SUCCESS for valid float"); }
Test(my_str_isfloat, integer_as_float, .init = redirect_all_std) { int a = my_str_isfloat("123"); cr_assert_eq(a, SUCCESS, "my_str_isfloat should return SUCCESS for integer"); }
Test(my_str_isfloat, float_with_leading_zero, .init = redirect_all_std) { int a = my_str_isfloat("0.456"); cr_assert_eq(a, SUCCESS, "my_str_isfloat should return SUCCESS for float with leading zero"); }
Test(my_str_isfloat, positive_sign, .init = redirect_all_std) { int a = my_str_isfloat("+123.456"); cr_assert_eq(a, SUCCESS, "my_str_isfloat should return SUCCESS for float with positive sign"); }
Test(my_str_isfloat, negative_sign, .init = redirect_all_std) { int a = my_str_isfloat("-123.456"); cr_assert_eq(a, SUCCESS, "my_str_isfloat should return SUCCESS for negative float"); }
Test(my_str_isfloat, negative_integer, .init = redirect_all_std) { int a = my_str_isfloat("-123"); cr_assert_eq(a, SUCCESS, "my_str_isfloat should return SUCCESS for negative integer"); }
Test(my_str_isfloat, only_decimal, .init = redirect_all_std) { int a = my_str_isfloat(".456"); cr_assert_eq(a, SUCCESS, "my_str_isfloat should return SUCCESS for only decimal part"); }
Test(my_str_isfloat, trailing_dot, .init = redirect_all_std) { int a = my_str_isfloat("123."); cr_assert_eq(a, SUCCESS, "my_str_isfloat should return SUCCESS for float with trailing dot"); }
Test(my_str_isfloat, multiple_dots, .init = redirect_all_std) { int a = my_str_isfloat("123.456.789"); cr_assert_eq(a, FAILURE, "my_str_isfloat should return FAILURE for multiple dots"); }
Test(my_str_isfloat, letters_in_string, .init = redirect_all_std) { int a = my_str_isfloat("123abc"); cr_assert_eq(a, FAILURE, "my_str_isfloat should return FAILURE for letters in string"); }
Test(my_str_isfloat, letters_and_dot, .init = redirect_all_std) { int a = my_str_isfloat("12.3abc"); cr_assert_eq(a, FAILURE, "my_str_isfloat should return FAILURE for letters after dot"); }
Test(my_str_isfloat, special_chars, .init = redirect_all_std) { int a = my_str_isfloat("123@456"); cr_assert_eq(a, FAILURE, "my_str_isfloat should return FAILURE for special characters"); }
Test(my_str_isfloat, space_in_string, .init = redirect_all_std) { int a = my_str_isfloat("123 456"); cr_assert_eq(a, FAILURE, "my_str_isfloat should return FAILURE for space in string"); }
Test(my_str_isfloat, only_sign, .init = redirect_all_std) { int a = my_str_isfloat("+"); cr_assert_eq(a, FAILURE, "my_str_isfloat should return FAILURE for only sign (no digits)"); }
Test(my_str_isfloat, only_dot, .init = redirect_all_std) { int a = my_str_isfloat("."); cr_assert_eq(a, FAILURE, "my_str_isfloat should return FAILURE for only dot (no digits)"); }
Test(my_str_isfloat, empty_string, .init = redirect_all_std) { int a = my_str_isfloat(""); cr_assert_eq(a, FAILURE, "my_str_isfloat should return FAILURE for empty string"); }
//endregion

//region my_str_isnegnum's tests
Test(my_str_isnegnum, positive_number, .init = redirect_all_std) { int a = my_str_isnegnum("123"); cr_assert_eq(a, FAILURE, "my_str_isnegnum should return FAILURE for positive number"); }
Test(my_str_isnegnum, negative_number, .init = redirect_all_std) { int a = my_str_isnegnum("-123"); cr_assert_eq(a, SUCCESS, "my_str_isnegnum should return SUCCESS for negative number"); }
Test(my_str_isnegnum, zero, .init = redirect_all_std) { int a = my_str_isnegnum("0"); cr_assert_eq(a, FAILURE, "my_str_isnegnum should return FAILURE for zero (positive)"); }
Test(my_str_isnegnum, negative_zero, .init = redirect_all_std) { int a = my_str_isnegnum("-0"); cr_assert_eq(a, SUCCESS, "my_str_isnegnum should return SUCCESS for negative zero"); }
Test(my_str_isnegnum, large_positive, .init = redirect_all_std) { int a = my_str_isnegnum("999999999"); cr_assert_eq(a, FAILURE, "my_str_isnegnum should return FAILURE for large positive number"); }
Test(my_str_isnegnum, large_negative, .init = redirect_all_std) { int a = my_str_isnegnum("-999999999"); cr_assert_eq(a, SUCCESS, "my_str_isnegnum should return SUCCESS for large negative number"); }
Test(my_str_isnegnum, with_letters, .init = redirect_all_std) { int a = my_str_isnegnum("123abc"); cr_assert_eq(a, FAILURE, "my_str_isnegnum should return FAILURE for positive number with letters"); }
Test(my_str_isnegnum, negative_with_letters, .init = redirect_all_std) { int a = my_str_isnegnum("-123abc"); cr_assert_eq(a, FAILURE, "my_str_isnegnum should return FAILURE for negative number with letters"); }
Test(my_str_isnegnum, with_space, .init = redirect_all_std) { int a = my_str_isnegnum("123 456"); cr_assert_eq(a, FAILURE, "my_str_isnegnum should return FAILURE for positive number with space"); }
//endregion

//region my_show_word_array's tests
// ...existing code...
//endregion
...
{
    char *buffer = openator("testing_empty_file");
...
{
    char *buffer = openator("non_existent_file");
...
{
    char *buffer = openator("testin_hello_file");
...
{
    off_t size = get_file_size_stat("testin_hello_file");
...
{
    off_t size = get_file_size_stat("non_existent_file");

    cr_assert_eq(size, FAILURE,
        "get_file_size_stat devrait retourner FAILURE pour un fichier inexistant");
}

//endregion

//region coverage_boost_misc_tests
...
Test(my_putstr, empty_string, .init = redirect_all_std)
{
    int ret = my_putstr("");
...
Test(my_show_word_array, two_words, .init = redirect_all_std)
{
    char *tab[] = {"hello", "world", NULL};
    int ret = my_show_word_array(tab);

    cr_assert_eq(ret, 0);
    cr_assert_stdout_eq_str("hello\nworld");
}

Test(my_show_word_array, empty_array, .init = redirect_all_std)
{
    char *tab[] = {NULL};
    int ret = my_show_word_array(tab);
...
Test(my_put_nbr, negative_value, .init = redirect_all_std)
{
    my_put_nbr(-42);
    cr_assert_stdout_eq_str("-42");
}

Test(my_strlen, normal_string, .init = redirect_all_std)
{
    cr_assert_eq(my_strlen("hello"), 5);
}

Test(my_strlen, empty_string, .init = redirect_all_std)
{
    cr_assert_eq(my_strlen(""), 0);
}

Test(my_strcpy, copies_content, .init = redirect_all_std)
{
    char dest[16] = {0};
...
Test(my_strcpy, copy_empty_source, .init = redirect_all_std)
{
    char dest[16] = "already_there";

    my_strcpy(dest, "");
    cr_assert_str_eq(dest, "");
}

Test(my_strndup, cut_to_n, .init = redirect_all_std)
{
    char *dup = my_strndup("bonjour", 3);

    cr_assert_not_null(dup);
    cr_assert_str_eq(dup, "bon");
    free(dup);
}

Test(my_strndup, zero_len, .init = redirect_all_std)
{
    char *dup = my_strndup("bonjour", 0);
...
Test(my_char_isnum, digit_char, .init = redirect_all_std)
{
    cr_assert_eq(my_char_isnum('7'), 1);
}

Test(my_char_isnum, non_digit_char, .init = redirect_all_std)
{
    cr_assert_eq(my_char_isnum('a'), SUCCESS);
}

Test(len_nb, zero_case, .init = redirect_all_std)
{
    cr_assert_eq(len_nb(0), 1);
}

Test(len_nb, negative_case, .init = redirect_all_std)
{
    cr_assert_eq(len_nb(-12345), 6);
}

Test(get_file_size_no_stat, existing_file, .init = redirect_all_std)
{
    int size = get_file_size_no_stat("testin_hello_file");

    cr_assert_eq(size, 11);
}

Test(get_file_size_no_stat, non_existent_file, .init = redirect_all_std)
{
    int size = get_file_size_no_stat("non_existent_file");
...
Test(free_list_basic, single_element_list)
{
    ...
    cr_assert_not_null(head, "Échec du malloc dans le test.");

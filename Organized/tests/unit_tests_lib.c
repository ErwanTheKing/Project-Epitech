...
Test(my_printf, test_octal_ll, .init = redirect_all_std)
{
    my_printf("%llo", 26);
    cr_assert_stdout_eq_str("32");
}

Test(my_printf, test_octal_j, .init = redirect_all_std)
{
    my_printf("%jo", 26);
    cr_assert_stdout_eq_str("32");
}

Test(my_printf, test_octal_z, .init = redirect_all_std)
{
    my_printf("%zo", 26);
    cr_assert_stdout_eq_str("32");
}

Test(my_printf, test_octal_, .init = redirect_all_std)
{
    my_printf("%-.4o", 26);
    cr_assert_stdout_eq_str("0032");
}
...
Test(my_printf, test_scientific_writing_bige, .init = redirect_all_std)
{
    my_printf("%E", 4252525.6);
    cr_assert_stdout_eq_str("4.252525E+06");
}
...
//region verif_function's tests

Test(verif_function, verif_malloc_basic, .init = redirect_all_std)
{
    char *str = "Hello";
    int a = verif_malloc(str);

    cr_assert_eq(a, 0);
}

Test(verif_function, verif_malloc_error, .init = redirect_all_std)
{
    char *str = {0};
    int a = verif_malloc(str);
...
Test(verif_function, verif_mstat_basic, .init = redirect_all_std)
{
    struct stat *stats = malloc(sizeof(struct stat));
    int a = verif_mstat(stats);

    cr_assert_eq(a, 0);
}

Test(verif_function, verif_mstat_error, .init = redirect_all_std)
{
    struct stat *stats = {0};
    int a = verif_mstat(stats);
...
Test(verif_function, verif_open_basic, .init = redirect_all_std)
{
    int fd = 5;
    int a = verif_open(fd);
...
Test(verif_function, verif_open_error, .init = redirect_all_std)
{
...
Test(verif_function, verif_read_basic, .init = redirect_all_std)
{
    int return_read = 5;
    int a = verif_read(return_read);

    cr_assert_eq(a, 0);
}

Test(verif_function, verif_read_error, .init = redirect_all_std)
{
    int return_read = -1;
    int a = verif_read(return_read);
...
Test(verif_function, verif_stat_basic, .init = redirect_all_std)
{
    int return_stat = 5;
    int a = verif_stat(return_stat);

    cr_assert_eq(a, 0);
}

Test(verif_function, verif_stat_error, .init = redirect_all_std)
{
    int return_stat = -1;
    int a = verif_stat(return_stat);
